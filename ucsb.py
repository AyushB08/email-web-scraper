...
URL = "https://www.cs.ucsb.edu/people/faculty" # webpage to scrape
...
domain_name = "@ucsb.edu" # domain name
unique_string = "@ucsb.edu<"  # unique string that tells the algorithm there is an email
...
while index < len(text):
    ...
    while counter >= 0:
        ...
        if text[counter] in ending_string:
            break
